...
@Component({
  ...
  templateUrl: './view-grunt-unmark-as-complete.page.html',
  styleUrls: ['./view-grunt-unmark-as-complete.page.scss'],
})
export class ViewGruntUnmarkAsCompletePage implements OnInit {
